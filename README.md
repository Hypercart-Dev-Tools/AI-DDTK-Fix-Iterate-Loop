...
| Tool | Description |
|------|-------------|
| **AI-DDTK MCP Server** | Unified stdio MCP package for LocalWP orchestration plus WPCC scan tools and scan/report resources |
...
│   ├── mcp-server/      # AI-DDTK MCP server package (stdio + LocalWP + WPCC tools/resources)
