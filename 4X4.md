...
- [x] Build `pw-auth` CLI with `login`, `status`, `clear` commands and dev-login-cli mu-plugin template
- [x] Fix implementation red flags: auth path (CWD), Playwright resolution, redirect encoding, PHP 7 compat, eval injection, subdirectory installs
- [x] Add Playwright Auth sections to AGENTS.md, README.md, temp/README.md with prerequisites and troubleshooting
- [x] Update CHANGELOG.md and 4X4.md for the pw-auth feature
...
3. README claims should match implementation reality — review auth paths, module resolution, encoding, and PHP version requirements before documenting a feature as ready.
