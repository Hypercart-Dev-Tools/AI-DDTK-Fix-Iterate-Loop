...
- [x] pw-auth is 1000+ lines of bash — bin/pw-auth - At this size, the script is approaching the maintainability limit for shell. Cookie handling, redirect following, and session management would benefit from being split into sourced helper files or rewritten in a more maintainable language. 
Phase 1 completed.
